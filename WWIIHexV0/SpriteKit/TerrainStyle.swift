...
enum TerrainStyle {
    ...
    static func unitFillColor(for faction: Faction) -> SKColor {
        ...
        case .britain:
            return SKColor(red: 0.68, green: 0.10, blue: 0.14, alpha: 1)
        case .france:
            return SKColor(red: 0.12, green: 0.29, blue: 0.72, alpha: 1)
        case .russia:
            return SKColor(red: 0.18, green: 0.48, blue: 0.34, alpha: 1)
        case .ottoman:
            return SKColor(red: 0.72, green: 0.12, blue: 0.18, alpha: 1)
        case .austria:
            return SKColor(red: 0.92, green: 0.78, blue: 0.20, alpha: 1)
        case .sardinia:
            return SKColor(red: 0.20, green: 0.52, blue: 0.82, alpha: 1)
        case .neutral:
            return SKColor(red: 0.50, green: 0.48, blue: 0.42, alpha: 1)
        }
    }
