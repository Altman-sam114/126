...
struct MapEditorScenarioMetadata: Codable, Equatable {
    var factions: [String]
    var maxTurns: Int
    var initialTurn: Int
    ...
    var humanControlledFactions: [String]?
    ...
    init(
        ...
        aiFaction: String,
        turnOrder: [String]? = nil,
        humanControlledFactions: [String]? = nil,
        ...
        self.humanControlledFactions = humanControlledFactions
    ...
    init(scenario: ScenarioDefinition) {
        self.init(
            ...
            humanControlledFactions: scenario.humanControlledFactions,
            victoryConditions: scenario.victoryConditions,
            dataNotes: scenario.dataNotes
        )
    }

    static let legacyFallback = MapEditorScenarioMetadata(
...
struct MapEditorDocument: Codable, Equatable, Identifiable {
    ...
    var scenarioMetadata: MapEditorScenarioMetadata?
    ...
    init(
        ...
        scenarioMetadata: MapEditorScenarioMetadata? = nil
    ) {
        self.id = id
