...
enum MapEditorExporter {
    ...
    private static func makeScenarioDefinition(from document: MapEditorDocument) -> ScenarioDefinition {
        let metadata = document.scenarioMetadata ?? .legacyFallback
        ...
        return ScenarioDefinition(
            ...
            turnOrder: metadata.turnOrder,
            humanControlledFactions: metadata.humanControlledFactions,
            ...
            victoryConditions: metadata.victoryConditions,
            dataNotes: metadata.dataNotes
        )
    }
