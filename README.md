...
| 维多利亚物流标签 | 🚧 黑海危机 key hex 可加载 port / rail / telegraph / expeditionaryDepot / siegeDepot 等标签；港口和远征 depot 可作为己方或 allied / coBelligerent 补给与安全撤退锚点 |
| 包围判定与惩罚 | ✅ |
